...
//Action method
	...
	public void LoanAMT() throws InterruptedException {
		...
		move1.dragAndDropBy(LoanAmtSlide, 50, 0).build().perform();
	}
	...
	public void LoanINt() throws InterruptedException {
		...
		move2.dragAndDropBy(loanIntrstSlide, 50, 0).build().perform();
	}
	...
	public void Tenure() throws InterruptedException {
		...
		move3.dragAndDropBy(loanTermSlide, 60, 0).build().perform();
		;
	}
